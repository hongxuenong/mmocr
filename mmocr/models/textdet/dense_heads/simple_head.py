...
class SimpleHead(HeadMixin, BaseModule):
    ...
    def power_sigmoid(self, prob_map, k=50):
        return torch.reciprocal(1.0 + torch.exp(-k * (prob_map)))
    ...
    def forward(self, inputs):
        ...
        prob_map = self.power_sigmoid(prob_map)
